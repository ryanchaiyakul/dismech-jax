...
# 7) Plot helpers
# =========================================================
def plot_force_displacement_grid(results_by_name, save_path, selected_names=None, title=None):
...
def plot_energy_strain_grid(results_by_name, save_path, selected_names=None, title=None):
    if selected_names is None:
        selected_names = list(results_by_name.keys())
...
def plot_stiffness_strain_grid(results_by_name, save_path, selected_names=None, title=None):
    if selected_names is None:
        selected_names = list(results_by_name.keys())
...
def plot_loss_histories(results_by_name, save_path, selected_names=None, title=None):
    if selected_names is None:
        selected_names = list(results_by_name.keys())
...
def main():
    ...
    plot_force_displacement_grid(
        results_by_name,
        save_path=os.path.join(fig_outdir, "ablation_A_force_displacement.png"),
        selected_names=ablation_A,
        title="Ablation A: parameterization and architecture",
    )
    plot_stiffness_strain_grid(
        results_by_name,
        save_path=os.path.join(fig_outdir, "ablation_A_stiffness_strain.png"),
        selected_names=ablation_A,
        title="Ablation A: parameterization and architecture",
    )
    plot_energy_strain_grid(
        results_by_name,
        save_path=os.path.join(fig_outdir, "ablation_A_energy_strain.png"),
        selected_names=ablation_A,
        title="Ablation A: parameterization and architecture",
    )
    plot_loss_histories(
        results_by_name,
        save_path=os.path.join(fig_outdir, "ablation_A_loss_histories.png"),
        selected_names=[name for name in ablation_A if name != "energy_baseline"],
    ...
    plot_force_displacement_grid(
        results_by_name,
        save_path=os.path.join(fig_outdir, "ablation_B_force_displacement.png"),
        selected_names=ablation_B,
        title="Ablation B: depth effect",
    )
    plot_stiffness_strain_grid(
        results_by_name,
        save_path=os.path.join(fig_outdir, "ablation_B_stiffness_strain.png"),
        selected_names=ablation_B,
        title="Ablation B: depth effect",
    )
    plot_energy_strain_grid(
        results_by_name,
        save_path=os.path.join(fig_outdir, "ablation_B_energy_strain.png"),
        selected_names=ablation_B,
        title="Ablation B: depth effect",
    )
    plot_loss_histories(
        results_by_name,
        save_path=os.path.join(fig_outdir, "ablation_B_loss_histories.png"),
        selected_names=ablation_B,
    ...
    # -----------------------------
    # Optional full grids for supplement
    # -----------------------------
